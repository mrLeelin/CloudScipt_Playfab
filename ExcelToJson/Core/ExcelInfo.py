...
class ExcelInfo:
    ...
    def __init__(self,excelName,hr,r,i):
        ...
        self.Round=r
        self.ignoreEmpty=i
        self.setupSheetInfos(xlrd.open_workbook(excelName),excelName)
    ...
    def FinalTable(self):
        ...
        for key in self.sheetInfos:
            ...
            if sheetInfo.idHead.Type==DataType.DIC:
                table[sheetInfo.tableName]=sheetInfo.sheet
            else:
                table[sheetInfo.tableName]=sheetInfo.table
        return table
    #处理表单父子关系
    ...
    # 预处理表单数据
    def setupSheetInfos(self, workbook,excelName):
        self.sheetInfos = {}
